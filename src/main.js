...
function render() {
  ...
  const selStart = restoreSearch || restoreAdd || restoreIg || restorePass ? focus.selectionStart : null;
  const selEnd = restoreSearch || restoreAdd || restoreIg || restorePass ? focus.selectionEnd : null;
  const restoreAct = restoreSearch || restoreAdd || restoreIg || restorePass ? focus.getAttribute("data-act") : null;
